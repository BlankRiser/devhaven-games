  ...
  return (
    <AnimatePresence>
      <motion.svg
        ...
        {...rest}>
        <motion.line variants={draw} 
          data-slot="hangman-pole-bottom" 
          custom={0} 
          x1="90" 
          y1="451" 
          x2="246" 
        ...
        />
        {visiblePart.head && 
        (<motion.circle variants={draw} 
          data-slot="hangman-head" 
          cx="368" 
          cy="140" 
          r="42" 
          stroke="currentColor" 
        ...
        (<motion.line variants={draw} 
          ...
          strokeWidth="2"
        />)}
        {visiblePart.handLeft && 
        (<motion.line variants={draw} 
          data-slot="hangman-hand-left" 
          x1="366.801" 
          y1="215.866" 
          x2="323.5" 
          y2="190.866" 
          ...
          strokeWidth="2"
        />)}
        {visiblePart.handRight && 
        (<motion.line variants={draw} 
          data-slot="hangman-hand-right" 
          x1="366.5" 
          y1="216.134" 
          x2="409.801" 
          y2="191.134" 
        ...
        (<motion.line variants={draw} 
          ...
          strokeWidth="2"
        />)}
        {visiblePart.legRight && 
        (<motion.line variants={draw} 
          data-slot="hangman-leg-right" 
          x1="367.866" 
          y1="313.5" 
          x2="392.866" 
          y2="356.801" 
